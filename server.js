...
${fotoSlots.length === 0
      ...
      : fotoSlots.map((s, i) => {
          ...
          const recorteInstr = s.recorte
            ? ` ATENÇÃO: esta foto é apenas um RECORTE/parte do imóvel (o imóvel é MAIS ALTO do que aparece na foto — o topo dele está cortado). Para ESTA foto, o enquadramento, o ângulo e o zoom devem ser os da PRÓPRIA FOTO — NÃO os do template. Ignore como a foto está posicionada no template original: NÃO tente completar, alongar, encolher, reposicionar ou recriar o restante do imóvel, e NÃO invente andares, topo, céu ou paisagem. Preencha a área de foto com esta imagem como um "cover", preservando o ângulo original. IMPORTANTE: posicione a foto de forma que o TOPO do imóvel encoste/ultrapasse a borda SUPERIOR da área de foto — o prédio deve "sair" pelo topo do quadro, transmitindo que ele continua para cima. NÃO deixe céu nem espaço vazio acima do topo cortado do imóvel; o corte deve ficar exatamente na borda superior, para que o prédio pareça mais alto do que a parte visível. Do template, use APENAS a identidade visual — cores, fontes, textos, grafismos e a disposição dos elementos gráficos ao redor —, nunca o enquadramento da foto.`
            : '';
