...
const TIPO_LABELS = { gerar: 'Geração de arte', previa: 'Prévia de texto', edicao: 'Edição mágica', oneclick: '1-Click Art', formato: 'Variação de formato', analise: 'Análise de template', transcricao: 'Transcrição' };
